...
dataSource.products = {//definicje produktów
  cake: { //produkt 1
    class: 'small', //opcje produktu
  ...
  breakfast: { //produkt 2
    ...
    params: { //właściwości/opcje wyboru do produktu2 breakfast
  ...
  pizza: {
    ...
    images: [
      ...
      '<img class=" sauce-tomato" src="images/pizza/tomato-sauce.svg">', //od tego img usuwamy klasy active
      ...
      '<img class=" toppings-basil" src="images/pizza/basil.svg">', //do tego img usuwamy klasy active
    ],
    params: {//właściwości/opcje wyboru do produktu3 pizza
  ...
  salad: {
    ...
    images: [
      ...
      '<img class=" ingredients-cucumber" src="images/salad/cucumber.svg" style="z-index: 1;">',//od tego img usuwamy klasy active
      ...
      '<img class=" ingredients-pepper" src="images/salad/black-pepper.svg" style="z-index: 7;">',//do tego img usuwamy klasy active
    ],
    params: {
      ingredients: {
        label: 'Ingredients',
